...
class AdresseController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('realEstateBundle:Adresse:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('realEstateBundle:Adresse')->find($id);
        ...
        return $this->render('realEstateBundle:Adresse:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('realEstateBundle:Adresse:edit.html.twig', array(
            'entity'      => $entity,
