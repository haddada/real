 ...
 */
class Administrateur extends \sprint2\realEstateBundle\Entity\Administrateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'sprint2\\realEstateBundle\\Entity\\Administrateur' . "\0" . 'id', '' . "\0" . 'sprint2\\realEstateBundle\\Entity\\Administrateur' . "\0" . 'nom', '' . "\0" . 'sprint2\\realEstateBundle\\Entity\\Administrateur' . "\0" . 'prenom', '' . "\0" . 'sprint2\\realEstateBundle\\Entity\\Administrateur' . "\0" . 'motDePasse', '' . "\0" . 'sprint2\\realEstateBundle\\Entity\\Administrateur' . "\0" . 'mail', '' . "\0" . 'sprint2\\realEstateBundle\\Entity\\Administrateur' . "\0" . 'privilege');
        }
